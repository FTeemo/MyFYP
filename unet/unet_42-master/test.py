...
def cal_miou(test_dir="/root/FYP/MyFYP/Dataset_Used_now/Test_Images",
             pred_dir="/root/FYP/MyFYP/unet/unet_42-master/results", gt_dir="/root/FYP/MyFYP/Dataset_Used_now/Test_Labels"):
    # ---------------------------------------------------------------------------#
